...
if exist ..\zxevo_fw_tns_vdac.bin del /f /q ..\zxevo_vdac_fw.bin
..\..\..\tools\mhmt\mhmt.exe -mlz -maxwin2048 ..\fpga\main_vdac.rbf fpga.mlz
...
..\..\..\tools\make_fw\make_fw.exe service.hex service.eep.hex ..\zxevo_fw_tns_vdac.bin version.txt %1
:quit