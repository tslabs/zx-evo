...
volatile u8 ps2keyboard_count;
volatile u8 ps2keyboard_timeout;
volatile u8 ps2keyboard_cmd_count;
volatile u8 ps2keyboard_cmd;

volatile u8  ps2keyboard_log[16];
volatile u8  ps2keyboard_log_start;
volatile u8  ps2keyboard_log_end;
...
volatile u8 ps2mouse_count;
volatile u8 ps2mouse_timeout;
