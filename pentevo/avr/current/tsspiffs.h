...
typedef TSF_RESULT (*tsf_erase_range_t)(u32, u32);
typedef TSF_RESULT (*tsf_poll_t)();
typedef void (*tsf_progress_t)(u32, u32);

#ifdef _MSC_VER
#pragma pack(push, 1)
#define TSF_PACKED
#elif defined(__GNUC__)
#define TSF_PACKED __attribute__((packed))
#else
#define TSF_PACKED
#endif

typedef struct TSF_PACKED
{
  u32 magic;
  u16 next_chunk;
  u8 type;
...
typedef struct
{
  ...
  tsf_erase_range_t hal_erase_range_func;
  tsf_poll_t poll_func;
  tsf_progress_t progress_func;
...
TSF_RESULT tsf_init_erased_chunk(TSF_CONFIG*, u32);
TSF_RESULT tsf_init_chunk_range(TSF_CONFIG*, u32, u32);
