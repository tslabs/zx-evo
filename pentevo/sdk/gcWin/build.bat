...
sdcc.exe -o bin\out.hex --std-c11 -mz80 --no-std-crt0 --opt-code-speed -Wl-b_CODE=0x0200 -Wl-b_DATA=0xB000 obj\crt0.rel obj\main.rel obj\gcWin.rel obj\numbers.rel obj\tsio.rel obj\keyboard.rel obj\mouse.rel
if errorlevel 1 pause & exit
