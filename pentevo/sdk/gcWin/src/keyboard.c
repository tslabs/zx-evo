...
;; cyrillic cp866 table
    .db     0xA8,0XE2,0xEC,0,KEY_SPACE              ; èòü
    .db     0xE0,0xAE,0xAB,0xA4,KEY_ENTER           ; ðîëä
    .db     0xAD,0xA3,0xE8,0xE9,0xA7                ; íãøùç
    .ascii  "6789054321"
    .db     0xA5,0xAA,0xE3,0xE6,0xA9                ; åêóöé
    .db     0xAF,0xA0,0xA2,0xEB,0xE4                ; ïàâûô
    .db     0xAC,0xE1,0xE7,0xEF,0x00                ; ìñ÷ÿ
    ...
    .db     0x8C,0x91,0x97,0x9F,0x00                ; ÌÑ×ß
