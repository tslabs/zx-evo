...
sdcc -Isrc -I../lib/sdk -I../lib/ft812 -I../lib/tsconf -I../lib/pff -mz80 --std-sdcc11 --opt-code-speed -Wl-b_CODE=0x0040 -Wl-b_DATA=0xB000 src/main.c ../lib/ft812/ft812.lib ../lib/tsconf/ts.lib ../lib/zifi/zifi.lib ../lib/pff/pff.lib ../lib/sdk/sdk.lib -o obj/out.hex
if errorlevel 1 pause & exit
